...
//import com.example.asifshafee.user2.utils.Common;
...
public class AutoCompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList autocomplete(String input,Activity activity) {
        ...
        StringBuilder jsonResults = new StringBuilder();
            ...
            String locationUrl = "";
            try {
                locationUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDiD8oTqHlpk8EI8XXmSvfEg0Qtuph2nkc&input=" + URLEncoder.encode(input, "UTF-8");
